...
import cv2
from LMDU_color import Self_Attn,Weight,VNet,WNet
...
def parse_args():
	...
	# parser.add_argument('--set_names', default=['DIV2K_valid_HR'],
	#                     help='directory of test dataset')  # DIV2K_valid_HR
	parser.add_argument('--sigma', default=50, type=int, help='noise level')
	parser.add_argument('--model_dir', default=os.path.join('models','lmdu'),
